angular.module('StockMarketApp-Ionic.controllers', [])
...
.controller('LoginSignupCtrl', ['$scope', '$firebaseAuth', '$firebaseArray', '$firebaseObject', 'modalService', 'userService',
  function($scope, $firebaseAuth, $firebaseArray, $firebaseObject, modalService, userService) {
